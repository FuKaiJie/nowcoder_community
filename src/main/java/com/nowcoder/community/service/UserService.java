...
public class UserService implements CommunityConstant {
    ...
    public Map<String, Object> register(User user) {
        ...
        //注册用户
        user.setSalt(CommunityUtil.generrateUUID().substring(0,5));
        user.setPassword(CommunityUtil.md5(user.getPassword() + user.getSalt()));
        user.setType(0);
        user.setStatus(0);
        user.setActivationCode(CommunityUtil.generrateUUID());
    ...
    public Map<String, Object> login(String username, String password, int expiredSecond) {
        ...
        loginTicket.setTicket(CommunityUtil.generrateUUID());
